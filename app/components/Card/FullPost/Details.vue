...
<template>
  <div class="h-full w-[94px] shrink-0 md:w-[108px]">
    <!-- Sale -->
    <div
      v-if="props.post.type === 'sale'"
      class="absolute bottom-0 flex h-[150%] w-[94px] shrink-0 flex-col justify-center gap-y-0.5 rounded-tr-2xl bg-azure-500 text-center font-ubuntu md:w-[108px] dark:bg-azure-400"
    >
      <!-- Type -->
      <span
    ...
    <div
      ...
      class="full absolute bottom-0 flex h-[150%] w-[94px] shrink-0 flex-col justify-center gap-y-0.5 rounded-tr-2xl bg-keppel-500 text-center font-ubuntu md:w-[108px] dark:bg-keppel-400"
    >
      <!-- Type -->
      <span
        class="relative top-0.5 mb-px font-bold leading-none md:leading-[22px]"
    ...
    <div
      ...
      class="absolute bottom-0 flex h-[150%] w-[94px] shrink-0 flex-col justify-center gap-y-0.5 rounded-tr-2xl bg-affair-500 text-center font-ubuntu md:w-[108px] dark:bg-affair-400"
    >
      <!-- Type -->
      <span
        class="relative top-0.5 mb-px font-bold leading-none md:leading-[22px]"
