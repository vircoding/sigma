...
import { AccessTokenExpiredError } from '~/classes/Error';
...
const { setPostPagePostType, setUpdatePagePostType } = useUIStore();
...
async function onEdit(type: PostType) {
  setUpdatePagePostType(type);
  ...
  >
    ...
    <div class="relative flex flex-col overflow-hidden rounded-xl bg-gray-200 dark:bg-gray-700">
      ...
      <aside class="flex items-center justify-evenly gap-x-2 px-6 py-2">
        ...
        <!-- Edit -->
        <ButtonIcon @click.stop="onEdit(post.type)">
          <UIcon
      ...
      >
        ...
        <div class="grid grid-cols-2 gap-x-6">
          ...
          <UButton
            ...
            block
            :disabled="isLoading"
            :ui="useUIConfig().blurCancelButtonConfig"
