...
import { BadRequestError, ConflictError, FormFieldError, MaxSizeError } from '~/classes/Error';
import { registerAgentSchema } from '~/schemas/RegisterSchema';
import type { RegisterAgentSchema } from '~/schemas/RegisterSchema';
