...
import { BadRequestError, ConflictError, FormFieldError } from '~/classes/Error';
import { registerClientSchema } from '~/schemas/RegisterSchema';
import type { RegisterClientSchema } from '~/schemas/RegisterSchema';
