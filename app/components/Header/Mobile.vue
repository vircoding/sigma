...
function onNavigateToInsert(type: PostType) {
  setInsertPagePostType(type);
  isSlideoverOpen.value = false;
}

function onNavigateToSearch(type: PostType) {
  setSearchPagePostType(type);
  isSlideoverOpen.value = false;
}
</script>
          ...
          <nav class="px-2 py-7 text-right sm:px-3 sm:py-8 md:px-4 md:py-8">
            <ul class="space-y-2">
              ...
              <li class="py-1">
                ...
                <ul class="leading-snug">
                  <li>
                    <NuxtLink :to="{ name: 'posts' }" @click="onNavigateToInsert('sale')">
                      <span :class="[useStyles().textSizeBase]">Ventas</span>
                    </NuxtLink>
                  </li>
                  <li>
                    <NuxtLink :to="{ name: 'posts' }" @click="onNavigateToInsert('rent')">
                      <span :class="[useStyles().textSizeBase]">Rentas</span>
                    </NuxtLink>
                  </li>
                  <li>
                    <NuxtLink :to="{ name: 'posts' }" @click="onNavigateToInsert('exchange')">
