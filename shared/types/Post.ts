...
export type SearchResultSale = SearchResultPartial & {
  type: 'sale';
  details: SaleDetails;
};
...
export type SearchResultRent = SearchResultPartial & {
  type: 'rent';
  details: RentDetails;
};
...
export type SearchResultExchange = SearchResultPartial & {
  type: 'exchange';
  details: ExchangeDetails;
};
...
export type SearchResult = SearchResultSale | SearchResultRent | SearchResultExchange;
...
export type SearchResultInstance = PostDB & {
  properties: PropertyDB[];
  images: ImageDB[];
  sale: SaleDB | null;
  rent: RentDB | null;
